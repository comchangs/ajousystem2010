...
#define	SEGMENT_NAME			"7-SEGMENT"		// 디바이스 이름
#define SEGMENT_MODULE_VERSION		"7-SEGMENT PORT V0.1"	// 디바이스 버전

#define SEGMENT_ADDRESS_GRID		0x14800000	// 7-seg의 Digit 를 선택하기 위한 레지스터 
#define SEGMENT_ADDRESS_DATA		0x14801000	// 7-seg를 디스플레이 하기 위한 레지스터
